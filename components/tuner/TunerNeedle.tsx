  ...
  return (
    <div className="mx-auto w-full max-w-xl px-2">
      <div className="relative h-16">
        ...
        <div className="absolute left-1/2 top-[8px] h-10 w-[2px] -translate-x-1/2 bg-[var(--foreground)]" />
        <div
        ...
        >
          <div
            ...
            style={{ borderColor: color, background: intonation === "in-tune" ? color : "transparent" }}
          />
        </div>
      ...
      <p className="tabular mt-1 text-center text-sm text-[var(--muted-fg)]">
